    ...
    >
      <svg viewBox="0 0 100 120" width={size} height={size * 1.2}>
        <path
          fill={fill}
          d="M50 4
             C50 4 38 16 24 20 C32 28 30 40 24 50
             C34 46 44 52 50 64
             C56 52 66 46 76 50 C70 40 68 28 76 20
             C62 16 50 4 50 4Z"
        />
        <path
          fill={fill}
          opacity={0.55}
          d="M49 64 L44 110 L50 112 L56 110 L51 64Z"
        />
        <path
          fill={fill}
          opacity={0.35}
          d="M50 64 C50 64 30 90 26 100 M50 64 C50 64 70 90 74 100"
          stroke={fill}
          strokeWidth={3}
          strokeLinecap="round"
          fillRule="evenodd"
...
function SceneIntro() {
  ...
  return (
    <AbsoluteFill
      style={{
        background:     `radial-gradient(ellipse at 50% 40%, ${C.bgMid} 0%, ${C.bg} 100%)`,
      ...
      >
        <div
          style={{
            ...
            justifyContent: "center",
            margin:         "0 auto 28px",
            background:     `radial-gradient(circle at 40% 40%, ${C.chestnut}, ${C.bg})`,
            boxShadow:      `0 0 40px ${C.gold}44, inset 0 0 30px rgba(0,0,0,0.5)`,
          }}
        >
          <svg viewBox="0 0 100 100" width={72} height={72}>
            <path
              fill={C.gold}
              d="M55 10 C60 12 70 20 72 30 C76 25 84 24 84 24 C84 24 80 32 76 34 C79 44 77 56 73 63 C70 69 64 73 62 82 L68 90 L60 90 L57 76 C54 82 52 87 49 90 L41 90 L45 74 C39 68 33 60 31 52 C28 42 31 30 39 23 C44 18 50 14 52 11 Z"
            />
            <circle cx="63" cy="36" r="4" fill={C.bg} />
            <circle cx="63" cy="36" r="2" fill={C.chestnut} />
          </svg>
        </div>
        <div style={{ fontFamily: "Montserrat, sans-serif", fontSize: 30, fontWeight: 700, letterSpacing: 7, color: C.gold, textTransform: "uppercase", lineHeight: 1 }}>La Cave</div>
        ...
        <div style={{ fontFamily: "Montserrat, sans-serif", fontSize: 10, fontWeight: 400, letterSpacing: 3, color: C.gold, opacity: 0.5, textTransform: "uppercase", marginTop: 8 }}>Dénicheur de grands vins · Depuis 1844</div>
      </div>
...
// ════════════════════════════════════════════════════════════════
// Scene 2 — TITLE  (frames 90–210, 4s)
// ════════════════════════════════════════════════════════════════
function SceneTitle() {
  const frame = useCurrentFrame();
  const { fps } = useVideoConfig();
  ...
  return (
    <AbsoluteFill
      style={{
        background:     `radial-gradient(ellipse at 50% 50%, ${C.bgMid} 0%, ${C.bg} 80%)`,
        justifyContent: "center",
        alignItems:     "center",
        flexDirection:  "column",
      }}
    >
      ...
      <div style={{ position: "relative", zIndex: 10, textAlign: "center", padding: "0 40px" }}>
        ...
        <div style={{ marginTop: 28, opacity: subOpacity }}>
          ...
          <div style={{ fontFamily: "Montserrat, sans-serif", fontSize: 12, fontWeight: 400, letterSpacing: 5, color: C.parchment, opacity: 0.55, textTransform: "uppercase", marginTop: 14 }}>Pessac-Léognan · Bordelais · Spiritueux · Sélections de saison</div>
        </div>
      </div>
    </AbsoluteFill>
  );
...
// ════════════════════════════════════════════════════════════════
// Scene 3 — BENEFITS  (frames 210–330, 4s)
// ════════════════════════════════════════════════════════════════
...
// ════════════════════════════════════════════════════════════════
// Scene 4 — DATE  (frames 330–450, 4s)
// ════════════════════════════════════════════════════════════════
function SceneDate() {
  const frame = useCurrentFrame();
  const { fps } = useVideoConfig();
  ...
  return (
    <AbsoluteFill style={{ background: `linear-gradient(180deg, ${C.bg} 0%, ${C.bgMid} 50%, ${C.bg} 100%)`, justifyContent: "center", alignItems: "center", flexDirection: "column" }}>
      ...
      <div style={{ position: "relative", zIndex: 10, textAlign: "center", opacity: dateOpacity }}>
        ...
        <div style={{ fontFamily: "'Playfair Display', serif", fontSize: 130, fontWeight: 900, color: C.white, lineHeight: 0.9, letterSpacing: -5, textShadow: "0 4px 30px rgba(0,0,0,0.4)" }}>11</div>
      ...
      <div style={{ position: "relative", zIndex: 10, textAlign: "center", marginTop: 52, opacity: subOpacity }}>
        <div style={{ fontFamily: "Montserrat, sans-serif", fontSize: 13, fontWeight: 400, letterSpacing: 3, color: C.gold, lineHeight: 1.9 }}>
    ...
    <AbsoluteFill style={{ background: `radial-gradient(ellipse at 50% 45%, ${C.bgMid} 0%, ${C.bg} 100%)`, justifyContent: "center", alignItems: "center", flexDirection: "column", opacity: fadeOut }}>
      ...
      <div style={{ position: "relative", zIndex: 10, textAlign: "center", padding: "0 80px" }}>
        ...
        <div style={{ opacity: subOpacity, marginTop: 52 }}>
          <GoldLine width={300} />
          <div style={{ fontFamily: "Montserrat, sans-serif", fontSize: 13, fontWeight: 300, letterSpacing: 2, color: C.parchment, opacity: 0.55, marginTop: 22, lineHeight: 1.9 }}>
            La Cave Cheval Quancard<br />
            36 Avenue de l'Aquitaine · 33560 Sainte-Eulalie<br />
        ...
        <div style={{ marginTop: 36, fontFamily: "Montserrat, sans-serif", fontSize: 9, fontWeight: 300, letterSpacing: 1, color: C.parchment, opacity: 0.3 }}>
